...
# LiteCoA-GRPO smoke run.
# Use this to verify the full training loop before launching a long run.
...
EXPERIMENT_NAME="nq-litecoa-grpo-qwen2.5-3b-smoke"
WAND_PROJECT="Search-R1"
TRAJECTORY_LOG_DIR="trajectory/litecoa_grpo"

RAY_TMPDIR="ray_tmp/litecoa_grpo_smoke"
RAY_SPILL_DIR="ray_spill/litecoa_grpo_smoke"
